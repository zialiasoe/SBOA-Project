function calculateAverage() {
    ...
    document.getElementById("PSOutput1").innerHTML = PSValue.toFixed(2);
    document.getElementById("PSOutput2").innerHTML = PSValue.toFixed(2);
    document.getElementById("PSOutput3").innerHTML = PSValue.toFixed(2);
    document.getElementById("PSOutput4").innerHTML = PSValue.toFixed(2);
    document.getElementById("FinalAverageOutput1").innerHTML = PSValue.toFixed(2);
    document.getElementById("FinalAverageOutput2").innerHTML = PSxWValue.toFixed(2);
    document.getElementById("FinalAverageOutput3").innerHTML = PSValue.toFixed(2);
    document.getElementById("FinalAverageOutput4").innerHTML = PSxWValue.toFixed(2);
    document.getElementById("FinalAverageOutput5").innerHTML = PSValue.toFixed(2);
    document.getElementById("FinalAverageOutput6").innerHTML = PSxWValue.toFixed(2);
    document.getElementById("FinalAverageOutput7").innerHTML = PSValue.toFixed(2);
    ...
    document.getElementById("FinalAverageOutput10").innerHTML = PSxW2Value.toFixed(2);
